...
Ya implementados: rebranding con landing y KPIs, sistema de rangos/insignias nominales con repaso inteligente, Analytics con radar/heatmap/evolución, informe del simulador, modo demo y certificado descargable. Pendiente en la hoja de ruta más amplia: ranking (comparativa entre compañeros, requeriría backend).
